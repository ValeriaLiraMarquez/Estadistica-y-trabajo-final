...
#3.1._Dimensión de la matriz

#Se ulitiza el siguiente comando para saber
...
#1.- Seleccionar las variables que vayamos a correlacionar,
#ocupamos:
...
#4.- Para saber el nombre y posición de las variable ocupamos:
# **colnames(BD)**
colnames(marvel_dc)
...
# *Nota: elegimos columnas nuevas ya que la número 4 y 6 son carácteres y necesitamos utilizar numéricas
