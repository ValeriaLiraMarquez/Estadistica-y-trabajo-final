...
# primaria "Emiliano Zapata". En total se 
# tienen 200 alumnos. 
...
# 1. Ejemplo: Tenemos 200 estudiantes y se quieren agrupar
# en equipos de 2 integrantes cada uno. 

# = 200 - Número de elementos 
...
# alumnos de cuarto y quinto grado de la escuela primaria 
# "Emiliano Zapata". En total se tiene 300 alumnos. 
